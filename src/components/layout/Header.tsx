...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#0B0E17]/95 backdrop-blur-xl text-white border-b border-white/10 shadow-2xl overflow-x-hidden max-w-full">
      {/* Top Cyberpunk Neon Announcement Bar */}
      <div className="bg-gradient-to-r from-[#992211] via-[#E05638] to-[#992211] text-white py-1.5 px-3 sm:px-4 text-center text-xs font-bold tracking-wide flex items-center justify-between border-b border-white/10 shadow-md">
      ...
      <div className="container mx-auto px-3 sm:px-4 max-w-7xl">
        ...
        {/* Mobile & iPad Slide-down Glass Drawer */}
        {mobileOpen && (
          <div className="lg:hidden border-t border-white/10 py-4 px-2 space-y-4 bg-[#0B0E17]/98 backdrop-blur-2xl animate-in slide-in-from-top-4 duration-300 shadow-2xl">
